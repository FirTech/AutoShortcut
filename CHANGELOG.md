...
- Support XGBoost model recognition
...
- Improve portable app main executable detection
- Improve Prevent template caching from reusing a result rendered with a previous context.

## [2.2.1] - 2026-02-28

### Fixed

- Improve exclude files from single file identification program
- Improve exclusion files
- Improve SFX program recognition
...
- Shorcut hotkey
- Support system version manifest
- Long path support
- Unit test

### Fixed

- Improve replace filter
- Improve from explorer start args

## [2.1.0] - 2025-11-05

### Added

- More path variables(`%Downloads%`, `%Videos%`, `%Pictures%`, `%Music%`, `%Favorites%`)

### Changed

- Remove exclude software keyword
- Optimize utils code

### Fixed

- Use the -d parameter to get the path name is incorrect.
